...
export class Dashboard1Component implements AfterViewInit {
  ...
  public lineChartData: Array<any> = [
    { data: [0, 50, 30, 60, 180, 120, 180, 80], label: 'Ventas ' },
    { data: [0, 100, 70, 100, 240, 180, 220, 140], label: 'Carlos ' },
    { data: [0, 150, 110, 240, 200, 200, 300, 200], label: 'Ganancia ' }
  ];

  public lineChartLabels: Array<any> = ['Enero', 'February', 'March', 'April', 'May', 'June', 'July', 'Aug'];
